...
<html lang="en">
<head>
<title>Apex Legends Stats</title>
<meta charset="utf-8">
...
<nav class="navbar navbar-expand-sm bg-dark navbar-dark">
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="collapsibleNavbar">
        ...
        <li class="nav-item">
          <a class="nav-link active bg-danger text-light mx-1" href="game2.php">Apex Legends</a>
        </li>
        <li class="nav-item">
...
<?php
	if(isset($_SESSION["username"])){
		if(isset($_SESSION["apexgamertag"]) && isset($_SESSION["apexplatform"])){
			...
			echo "<form class='bg-dark' action='apex.php' method='POST'>
    				<div class='mb-3 mt-3'>
      				  <label for='platform'><b>Platform you play Apex Legends on:</b></label><br>
