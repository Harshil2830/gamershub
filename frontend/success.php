...
<div class="topnav" id="myTopnav">
  ...
  <a id="login" style="display:block;" onclick="document.getElementById('id01').style.display='block'" class="active">Login</a>
...
<h1> Registration Successful! Login to see your stats. </h1>
